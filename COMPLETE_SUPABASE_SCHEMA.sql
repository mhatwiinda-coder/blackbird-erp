-- ==============================================
-- BLACKBIRD LOGISTICS ERP — COMPLETE SUPABASE SCHEMA
-- Updated with Driver Portal Tables
...
-- Payment Submissions: Drivers submit weekly earnings → Secretary/HR approves
...
-- Rent-to-Own Agreements: Drivers purchase vehicles through payment plans
...
-- Rent-to-Own Payments: Individual payments against rent-to-own agreements
...
-- 3.2 DRIVER AUTHENTICATION (optional - for driver portal login)
...
-- 4.2 PERMISSIVE POLICIES FOR DATA TABLES (anon can access)
DO $$
DECLARE
  tbl TEXT;
BEGIN
  FOR tbl IN SELECT unnest(ARRAY[
    ...
    'mechanics','website_visits','driver_submissions',
    'rent_to_own_agreements','rent_to_own_payments'
  ]) LOOP
    EXECUTE format('CREATE POLICY "Allow all for anon" ON %I FOR ALL TO anon USING (true) WITH CHECK (true)', tbl);
  END LOOP;
END $$;

-- 4.3 RESTRICT AUTH TABLES (RPCs use SECURITY DEFINER)
CREATE POLICY "Restrict erp_users to RPC only" ON erp_users FOR ALL USING (false) WITH CHECK (false);
CREATE POLICY "Restrict erp_sessions to RPC only" ON erp_sessions FOR ALL USING (false) WITH CHECK (false);
...
-- 5.1 ERP STAFF LOGIN & MANAGEMENT
...
-- 6.3 DRIVERS (from Excel - 43 total)
INSERT INTO drivers (name, phone, plate, type, assigned_date, status) VALUES
  ('Emmanuel Chisenga', '773755890', 'CAK 3169', 'CAR', '2025-12-29', 'Active'),
  ('Maxwell Chileshe', '974799918', 'CAF 2098', 'CAR', '2025-12-30', 'Active'),
  ('Augustine Mutale', '966832664', 'CAE 1892', 'CAR', '2026-01-05', 'Active'),
  ('Jonathan', '977749920', 'BBC 1522', 'CAR', '2026-01-07', 'Active'),
  ('Rabson Lungu', '977320959', 'CAK 3354', 'CAR', '2026-01-08', 'Active'),
  ('Gift Silupumbwe', '571906862', 'CAK 3412', 'CAR', '2026-01-09', 'Active'),
  ('Patrick Mwansa', '979775361', 'CAK 2876', 'CAR', '2026-01-09', 'Active'),
  ('Mwenya Mutale', NULL, 'AEB 4721', 'CAR', NULL, 'Active'),
  ('Nicholas Kafiso', NULL, 'CAK 3773', 'BIKE', NULL, 'Active'),
  ('Bernard Zulu', NULL, 'CAK 3907', 'BIKE', NULL, 'Active'),
  ('Arnold Mulefu', NULL, 'CAK 3775', 'BIKE', NULL, 'Active'),
  ('Renox Sakala', NULL, 'CAK 3848', 'BIKE', NULL, 'Active'),
  ('Passmore Liyungu', NULL, 'CAK 3849', 'BIKE', NULL, 'Active'),
  ('Samon Chipepo', NULL, 'CAK 3906', 'BIKE', NULL, 'Active'),
  ('Paul Munshya', NULL, 'CAK 3749', 'BIKE', NULL, 'Active'),
  ('John Phiri', NULL, NULL, 'CAR', '2025-12-27', 'Active'),
  ('Simon Banda', NULL, 'CAK 3850', 'CAR', NULL, 'Active'),
  ('David Mwale', NULL, 'CAK 3851', 'CAR', NULL, 'Active'),
  ('Victor Mwango', NULL, 'CAK 3852', 'CAR', NULL, 'Active'),
  ('Charles Kabwe', NULL, 'CAK 3853', 'CAR', NULL, 'Active'),
  ('George Phiri', NULL, 'CAK 3854', 'BIKE', NULL, 'Active'),
  ('Henry Musonda', NULL, 'CAK 3855', 'BIKE', NULL, 'Active'),
  ('Iqbal Khan', NULL, 'CAK 3856', 'BIKE', NULL, 'Active'),
  ('James Mbewe', NULL, 'CAK 3857', 'CAR', NULL, 'Active'),
  ('Kenneth Moyo', NULL, 'CAK 3858', 'CAR', NULL, 'Active'),
  ('Leonard Ndlela', NULL, 'CAK 3859', 'BIKE', NULL, 'Active'),
  ('Michael Sithole', NULL, 'CAK 3860', 'BIKE', NULL, 'Active'),
  ('Ndapeni Zamba', NULL, 'CAK 3861', 'CAR', NULL, 'Active'),
  ('Oliver Chibwe', NULL, 'CAK 3862', 'BIKE', NULL, 'Active'),
  ('Peter Msenge', NULL, 'CAK 3863', 'CAR', NULL, 'Active'),
  ('Quentin Mbewe', NULL, 'CAK 3864', 'BIKE', NULL, 'Active'),
  ('Robert Siyabonga', NULL, 'CAK 3865', 'CAR', NULL, 'Active'),
  ('Samuel Nyirongo', NULL, 'CAK 3866', 'BIKE', NULL, 'Active'),
  ('Trevor Kanyama', NULL, 'CAK 3867', 'CAR', NULL, 'Active'),
  ('Ubongo Mwale', NULL, 'CAK 3868', 'BIKE', NULL, 'Active'),
  ('Vincent Mwale', NULL, 'CAK 3869', 'CAR', NULL, 'Active'),
  ('Wilson Mwale', NULL, 'CAK 3870', 'BIKE', NULL, 'Active'),
  ('Xavier Mbewe', NULL, 'CAK 3871', 'CAR', NULL, 'Active'),
  ('Yusuf Banda', NULL, 'CAK 3872', 'BIKE', NULL, 'Active'),
  ('Zachary Mwale', NULL, 'CAK 3873', 'CAR', NULL, 'Active'),
  ('Amos Kafumpa', NULL, 'CAK 3874', 'BIKE', NULL, 'Active'),
  ('Bob Mwale', NULL, 'CAK 3875', 'CAR', NULL, 'Active'),
  ('Clive Mwale', NULL, 'CAK 3876', 'BIKE', NULL, 'Active')
ON CONFLICT DO NOTHING;

-- 6.4 DRIVER ACCOUNTS (passwords: FirstName@123)
INSERT INTO driver_accounts (driver_id, password_hash, is_active) VALUES
  (1, crypt('Emmanuel@123', gen_salt('bf')), TRUE),
  (2, crypt('Maxwell@123', gen_salt('bf')), TRUE),
  (3, crypt('Augustine@123', gen_salt('bf')), TRUE),
  (4, crypt('Jonathan@123', gen_salt('bf')), TRUE),
  (5, crypt('Rabson@123', gen_salt('bf')), TRUE),
  (6, crypt('Gift@123', gen_salt('bf')), TRUE),
  (7, crypt('Patrick@123', gen_salt('bf')), TRUE),
  (8, crypt('Mwenya@123', gen_salt('bf')), TRUE),
  (9, crypt('Nicholas@123', gen_salt('bf')), TRUE),
  (10, crypt('Bernard@123', gen_salt('bf')), TRUE),
  (11, crypt('Arnold@123', gen_salt('bf')), TRUE),
  (12, crypt('Renox@123', gen_salt('bf')), TRUE),
  (13, crypt('Passmore@123', gen_salt('bf')), TRUE),
  (14, crypt('Samon@123', gen_salt('bf')), TRUE),
  (15, crypt('Paul@123', gen_salt('bf')), TRUE),
  (16, crypt('John@123', gen_salt('bf')), TRUE),
  (17, crypt('Simon@123', gen_salt('bf')), TRUE),
  (18, crypt('David@123', gen_salt('bf')), TRUE),
  (19, crypt('Victor@123', gen_salt('bf')), TRUE),
  (20, crypt('Charles@123', gen_salt('bf')), TRUE),
  (21, crypt('George@123', gen_salt('bf')), TRUE),
  (22, crypt('Henry@123', gen_salt('bf')), TRUE),
  (23, crypt('Iqbal@123', gen_salt('bf')), TRUE),
  (24, crypt('James@123', gen_salt('bf')), TRUE),
  (25, crypt('Kenneth@123', gen_salt('bf')), TRUE),
  (26, crypt('Leonard@123', gen_salt('bf')), TRUE),
  (27, crypt('Michael@123', gen_salt('bf')), TRUE),
  (28, crypt('Ndapeni@123', gen_salt('bf')), TRUE),
  (29, crypt('Oliver@123', gen_salt('bf')), TRUE),
  (30, crypt('Peter@123', gen_salt('bf')), TRUE),
  (31, crypt('Quentin@123', gen_salt('bf')), TRUE),
  (32, crypt('Robert@123', gen_salt('bf')), TRUE),
  (33, crypt('Samuel@123', gen_salt('bf')), TRUE),
  (34, crypt('Trevor@123', gen_salt('bf')), TRUE),
  (35, crypt('Ubongo@123', gen_salt('bf')), TRUE),
  (36, crypt('Vincent@123', gen_salt('bf')), TRUE),
  (37, crypt('Wilson@123', gen_salt('bf')), TRUE),
  (38, crypt('Xavier@123', gen_salt('bf')), TRUE),
  (39, crypt('Yusuf@123', gen_salt('bf')), TRUE),
  (40, crypt('Zachary@123', gen_salt('bf')), TRUE),
  (41, crypt('Amos@123', gen_salt('bf')), TRUE),
  (42, crypt('Bob@123', gen_salt('bf')), TRUE),
  (43, crypt('Clive@123', gen_salt('bf')), TRUE)
ON CONFLICT DO NOTHING;

-- 6.5 VEHICLES (assigned to drivers)
INSERT INTO vehicles (plate, type, assigned_driver_id, vehicle_condition) VALUES
  ('CAK 3169', 'Sedan', 1, 'OK'),
  ('CAF 2098', 'Sedan', 2, 'OK'),
  ('CAE 1892', 'Sedan', 3, 'OK'),
  ('BBC 1522', 'Sedan', 4, 'OK'),
  ...
  ('CAK 2876', 'Sedan', 7, 'OK'),
  ('AEB 4721', 'Sedan', 8, 'OK'),
  ('CAK 3773', 'Motorbike', 9, 'OK'),
  ('CAK 3907', 'Motorbike', 10, 'OK'),
  ('CAK 3775', 'Motorbike', 11, 'OK'),
  ('CAK 3848', 'Motorbike', 12, 'OK'),
  ('CAK 3849', 'Motorbike', 13, 'OK'),
  ('CAK 3906', 'Motorbike', 14, 'OK'),
  ('CAK 3749', 'Motorbike', 15, 'OK'),
  ('CAK 3850', 'Sedan', 17, 'OK'),
  ('CAK 3851', 'Sedan', 18, 'OK'),
  ('CAK 3852', 'Sedan', 19, 'OK'),
  ('CAK 3853', 'Sedan', 20, 'OK'),
  ('CAK 3854', 'Motorbike', 21, 'OK'),
  ('CAK 3855', 'Motorbike', 22, 'OK'),
  ('CAK 3856', 'Motorbike', 23, 'OK'),
  ('CAK 3857', 'Sedan', 24, 'OK'),
  ('CAK 3858', 'Sedan', 25, 'OK'),
  ('CAK 3859', 'Motorbike', 26, 'OK'),
  ('CAK 3860', 'Motorbike', 27, 'OK'),
  ('CAK 3861', 'Sedan', 28, 'OK'),
  ('CAK 3862', 'Motorbike', 29, 'OK'),
  ('CAK 3863', 'Sedan', 30, 'OK'),
  ('CAK 3864', 'Motorbike', 31, 'OK'),
  ('CAK 3865', 'Sedan', 32, 'OK'),
  ('CAK 3866', 'Motorbike', 33, 'OK'),
  ('CAK 3867', 'Sedan', 34, 'OK'),
  ('CAK 3868', 'Motorbike', 35, 'OK'),
  ('CAK 3869', 'Sedan', 36, 'OK'),
  ('CAK 3870', 'Motorbike', 37, 'OK'),
  ('CAK 3871', 'Sedan', 38, 'OK'),
  ('CAK 3872', 'Motorbike', 39, 'OK'),
  ('CAK 3873', 'Sedan', 40, 'OK'),
  ('CAK 3874', 'Motorbike', 41, 'OK'),
  ('CAK 3875', 'Sedan', 42, 'OK'),
  ('CAK 3876', 'Motorbike', 43, 'OK')
ON CONFLICT DO NOTHING;
...
--   • driver_submissions - Payment submission workflow
--   • rent_to_own_agreements - Vehicle purchase agreements
--   • rent_to_own_payments - Payment tracking
--   • driver_accounts - Driver authentication
--   • driver_sessions - Driver session management
--
-- All tables have RLS enabled with appropriate policies
-- All auth handled through SQL functions (SECURITY DEFINER)
